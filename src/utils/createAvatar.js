...
function getAvatarColor(name) {
  ...
  if (INFO_NAME.includes(getFirstCharacter(name))) return 'primary';
  if (SUCCESS_NAME.includes(getFirstCharacter(name))) return 'primary';
  if (WARNING_NAME.includes(getFirstCharacter(name))) return 'primary';
  if (ERROR_NAME.includes(getFirstCharacter(name))) return 'primary';
  return 'default';
}
